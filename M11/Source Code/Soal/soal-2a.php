    ...
    <body>
        <div class="grid-container">
            ...
            <div class="main">
                ...
                <br/>
                <div class="konten">
                    Konsep dasar web dan internet merupakan hal yang sangat penting untuk dipelajari. Hal ini
                    dikarenakan web dan internet merupakan hal yang sangat mendasar dalam dunia pemrograman.
                    Dengan mempelajari konsep dasar web dan internet, kita dapat memahami bagaimana cara kerja
                    web dan internet.
                </div>
            </div>
            <div class="footer">
