    ...
    <body>
        <div class="grid-container">
            ...
            <div class="main">
                ...
                <br/>
                <div class="konten">
                    Konsep Dasar Javascript merupakan konsep dasar yang harus dikuasai oleh seorang web developer. Dengan
                    menguasai konsep dasar ini, seorang web developer dapat membuat sebuah website yang interaktif dan
                    dinamis.
                </div>
            </div>
            <div class="footer">
